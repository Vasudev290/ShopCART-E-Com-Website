...
const addressList = [ 
    { iconName: 'icofont-google-map', text: ' Bnagalore,IN.' }, 
    { iconName: 'icofont-phone', text: ' +91 9360390839' }, 
    ...
    <div className="footer-top dark-view padding-tb">
            <div className="container">
                <div className="row g-4 row-cols-xl-4 row-cols-sm-2 row-cols-1 justify-content-center">
                    <div className="col">
                        <div className="footer-item our-adderss">
    ...
    <div className="footer-bottom">
        <div className="container">
            <div className="section-wrapper">
                <p>&copy; 2024 <Link to="/">Shop Cart</Link>Designed By <a href="#" target='_black'>VD Webs</a></p>
