...
const title = (
    <h2 className='title'>Join on Day Long Free Workshop for<b> Adavance <span> Mastering</span></b> on sales</h2>
)
                     ...
                     <div className="col">
                        <div className="section-wrapper">
                            ...
                            <form className='register-form'>
                                  <input type="text" name='name' placeholder='User' className='reg-input' />
